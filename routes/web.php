...
use App\Http\Controllers\ComputerFormattingController;
...
/** Routes for computer */
Route::post('/computer/formatting/create', [ComputerFormattingController::class, 'store'])->name('computer.formatting.store');
